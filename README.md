...
```sh
git clone git@github.com:Xaeroxe/my-factorio-computers.git
cd my-factorio-computers
```
...
#### Commit your changes
```sh
git commit -m 'Starting my-factorio-computers'
...
```sh
./mill my-factorio-computers.test
```
